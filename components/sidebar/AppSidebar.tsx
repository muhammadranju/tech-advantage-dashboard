...
//         </div>
//         <div className="flex items-center gap-2 cursor-pointer absolute right-0 top-5">
//           <FiSidebar className="text-white w-10" />
//         </div>
//       </SidebarHeader>
...
//           </div>
//           <div
//             className="flex items-center gap-2 cursor-pointer absolute right-0 top-5"
//             onClick={toggleSidebar}
//           >
//             <FiSidebar className="text-white w-10 hover:text-gray-300 transition-colors" />
//           </div>
//         </SidebarHeader>
