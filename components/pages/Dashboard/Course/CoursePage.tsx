...
// import { useGetCoursesQuery } from "@/lib/redux/features/api/courses/coursesSliceApi";
// import {
//   ArrowRight,
//   Check,
//   Play,
...
//   const { data: coursesData } = useGetCoursesQuery(null);
...
//             _id: String(course._id || Date.now()),
...
//       prev.map((course) =>
//         course._id === id
//           ? { ...course, name: editValue.trim(), slug: newSlug }
//           : course
//       )
//     );
//     setEditingId(null);
